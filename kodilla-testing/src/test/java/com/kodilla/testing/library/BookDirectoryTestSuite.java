...
public class BookDirectoryTestSuite {
    ...
    public void testListBooksInHandsOf() {
        ...
        LibraryDatabase libraryDatabaseMock = mock(LibraryDatabase.class);
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
        LibraryUser libraryUser = new LibraryUser("Andrzej", "Kowalski", "11111111111");
        LibraryUser libraryUser1 = new LibraryUser("Bartek", "Nowak", "22222222222");
        LibraryUser libraryUser2 = new LibraryUser("Waldemar", "Kun", "33333333333");
        List<Book> resultListOfBooks = generateListOfNBooks(1);
        List<Book> resultListOfBooks1 = generateListOfNBooks(5);
        List<Book> resultListOfBooks12 = new ArrayList<>();
        ...
        when(libraryDatabaseMock.listBooksInHandsOf(libraryUser2))
                .thenReturn(resultListOfBooks12);
        ...
        List<Book>bookList2 = bookLibrary.listBooksInHandsOf(libraryUser2);
        assertEquals(1, bookList.size());
        assertEquals(5, bookList1.size());
