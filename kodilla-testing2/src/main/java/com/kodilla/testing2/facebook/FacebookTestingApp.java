...
public class FacebookTestingApp {
    ...
    public static final String XPATH_SELECT_DAY = "//div[contains(@class, \"_5dbb\")]/div/span/span/select[1]";
    public static final String XPATH_SELECT_MONTH = "//div[contains(@class, \"_5dbb\")]/div/span/span/select[2]";
    public static final String XPATH_SELECT_YEAR = "//div[contains(@class, \"_5dbb\")]/div/span/span/select[3]";
